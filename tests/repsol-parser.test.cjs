...
test('modern separa total factura de total a pagar y cupón Waylet',()=>{
 ...
 assert.equal(r.periods.P1.consumption,69.56);assert.equal(r.periods.P3.consumption,62.75);assert.equal(r.contracted.P1,4.6);assert.equal(r.maximeters.P1,3.86);
});
