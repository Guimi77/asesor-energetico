...
function realLayoutFixture(){
  ...
  const p2=[
    ...
    '300000001 Energía capacitiva P1 27/04/2026 499 31/05/2026 499 0 kVArh','300000001 Energía capacitiva P2 27/04/2026 884 31/05/2026 890 6 kVArh','300000001 Energía capacitiva P3 27/04/2026 897 31/05/2026 899 2 kVArh','300000001 Energía capacitiva P4 27/04/2026 1.093 31/05/2026 1.094 1 kVArh','300000001 Energía capacitiva P5 27/04/2026 563 31/05/2026 563 0 kVArh','300000001 Energía capacitiva P6 27/04/2026 4.953 31/05/2026 4.954 1 kVArh',
    '300000001 Energía reactiva P1 27/04/2026 256 31/05/2026 256 0 kVArh','300000001 Energía reactiva P2 27/04/2026 495 31/05/2026 496 1 kVArh','300000001 Energía reactiva P3 27/04/2026 248 31/05/2026 249 1 kVArh','300000001 Energía reactiva P4 27/04/2026 286 31/05/2026 286 0 kVArh','300000001 Energía reactiva P5 27/04/2026 288 31/05/2026 288 0 kVArh'
  ];
  const p3=[
    '300000001 Energía reactiva P6 27/04/2026 157 31/05/2026 160 3 kVArh',
    '300000001 Maxímetro P1 27/04/2026 0 31/05/2026 0 0 kW','300000001 Maxímetro P2 27/04/2026 0 31/05/2026 1 1 kW','300000001 Maxímetro P3 27/04/2026 0 31/05/2026 0 0 kW','300000001 Maxímetro P4 27/04/2026 0 31/05/2026 0 0 kW','300000001 Maxímetro P5 27/04/2026 0 31/05/2026 0 0 kW','300000001 Maxímetro P6 27/04/2026 0 31/05/2026 0 0 kW',
    'Última lectura: real','Nº contador: 300000001','Peaje de acceso a la red (ATR): 3.0TD','Potencia contratada (kW): 16 / 16 / 16 / 16 / 16 / 16','Fecha final del contrato: 25/08/2027','Permanencia: Si (Fecha fin 05/09/2026)','Empresa distribuidora: EDISTRIBUCIÓN REDES DIGITALES S.L.U.','Número de contrato de acceso: 500000000006','Identificación punto de suministro (CUPS): ES 0000 0000 0000 0001 AA','Forma de pago: DOMICILIACION BANCARIA'
  ];
  return d(p1,p2,p3);
}

function browserGroupedDianaFixture(){
  const p1=['FACTURA DE ELECTRICIDAD','IBERDROLA CLIENTES, S.A.U.','CONTRATO jg PDF','ALICIA PRUEBA SINTETICA CLIENTE ALFA','Titular C/ VIA PRUEBA, 17-., LC 18','PALMA','ALICIA PRUEBA SINTETICA CLIENTE','ALFA 07199 PALMA DE MALLORCA (ILLES BALEARS)','Dirección de suministro:','C/ VIA PRUEBA, 17-., LC 18','PALMA 07199 PALMA DE','MALLORCA (ILLES BALEARS)','Nº DE CONTRATO: 600000001','RESUMEN DE FACTURA','PERIODO DE FACTURACIÓN: Nº FACTURA:','27/04/2026 - 31/05/2026 21260608010256253','DIAS FACTURADOS: FECHA DE EMISIÓN:','34 8 de junio de 2026','EMPRESA RESPONSABLE. Controla tu consumo energético con nuestro'];
...
test('Iberdrola 3.0TD real layout parses identity, P1-P6, contract data and exact economic balance',()=>{
  ...
  assert.equal(r.contract,'600000001');
  ...
  assert.equal(r.meterNumber,'300000001');
