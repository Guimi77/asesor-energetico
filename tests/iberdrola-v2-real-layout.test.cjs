...
function carla(){
  return doc([
    'FACTURA DE','ELECTRICIDAD','IBERDROLA CLIENTES, S.A.U.','CONTRATO','CLIENTE PRUEBA ALFA',
    'Titular Potencia: C/ DE LA PRUEBA, 5','CLIENTE PRUEBA ALFA Potencia punta: 5,75 kW','Potencia valle: 5,75 kW',
    'Dirección de suministro:','C/ DE LA PRUEBA, 5 07190','ESPORLES (ILLES BALEARS)','Nº DE CONTRATO: 600000002',
    ...
    'TOTAL IMPORTE FACTURA 111,15 €','NIF titular del contrato: 00000001R','Peaje de acceso a la red (ATR): 2.0TD',
    'Empresa distribuidora: EDISTRIBUCIÓN REDES DIGITALES S.L.U.','Número de contrato de acceso: 500000000007',
...
function diana(){
  return doc([
    'FACTURA DE','ELECTRICIDAD','IBERDROLA CLIENTES, S.A.U.','CONTRATO','ALICIA PRUEBA SINTETICA CLIENTE ALFA',
    'Titular C/ VIA PRUEBA, 17-., LC 18','ALICIA PRUEBA SINTETICA CLIENTE','ALFA 07199 PALMA DE MALLORCA (ILLES BALEARS)',
    'Dirección de suministro:','C/ VIA PRUEBA, 17-., LC 18','PALMA 07199 PALMA DE MALLORCA (ILLES BALEARS)',
    'Nº DE CONTRATO: 600000001','RESUMEN DE FACTURA','PERIODO DE FACTURACIÓN: Nº FACTURA:',
    ...
    '300000001 Maxímetro P1 27/04/2026 0 31/05/2026 0 0 kW',
    '300000001 Maxímetro P2 27/04/2026 0 31/05/2026 1 1 kW',
    '300000001 Maxímetro P3 27/04/2026 0 31/05/2026 0 0 kW',
    '300000001 Maxímetro P4 27/04/2026 0 31/05/2026 0 0 kW',
    '300000001 Maxímetro P5 27/04/2026 0 31/05/2026 0 0 kW',
    '300000001 Maxímetro P6 27/04/2026 0 31/05/2026 0 0 kW',
    'Última lectura: real','Peaje de acceso a la red (ATR): 3.0TD','Potencia contratada (kW): 16 / 16 / 16 / 16 / 16 / 16',
    'Empresa distribuidora: EDISTRIBUCIÓN REDES DIGITALES S.L.U.','Número de contrato de acceso: 500000000006',
    'Identificación punto de suministro (CUPS): ES 0000 0000 0000 0001 AA'
  ]);
}

function assertCarla(r){
  assert.equal(r.readOk,true); assert.equal(r.company,'CLIENTE PRUEBA ALFA'); assert.equal(r.cups,'ES0000000000000002AA');
...
function assertDiana(r){
  assert.equal(r.readOk,true); assert.equal(r.company,'ALICIA PRUEBA SINTETICA CLIENTE ALFA'); assert.equal(r.cups,'ES0000000000000001AA');
